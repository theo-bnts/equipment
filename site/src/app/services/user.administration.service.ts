...
export default class UserAdministrationService {
  ...
  getUserOrganizations(userEmailAddress: string): Observable<any> {
    ...
    return this.http
      ...
      `${environment.API_BASE_URL}/administration/users/organizations?user_email_address=${encodeURIComponent(userEmailAddress)}`,
      { headers },
    )
  ...
  addUserToOrganization(
    ...
    return this.http.put<void>(
      `${environment.API_BASE_URL}/administration/users/organizations`,
      body,
      { headers },
    );
  }
