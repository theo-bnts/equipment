...
export default class ReferentialAdministrationService {
  ...
  getLoans(): Observable<any> {
    ...
    return this.http
      .get<{
      datas: any;
    }>(`${environment.API_BASE_URL}/administration/loans`, { headers })
  ...
  deleteLoan(equipmentCode: string): Observable<void> {
    ...
    return this.http.request<void>(
      'delete',
      `${environment.API_BASE_URL}/administration/loans`,
      { headers, body },
    );
  }
  ...
  updateLoanState(equipmentCode: string, loanState: string): Observable<void> {
    ...
    return this.http.patch<void>(
      `${environment.API_BASE_URL}/administration/loans/last`,
      body,
      { headers },
    );
  }
  ...
  createType(typeName: string, organizationOnly: boolean): Observable<void> {
    ...
    return this.http.put<void>(
      `${environment.API_BASE_URL}/administration/types`,
      body,
      { headers },
    );
  }
  ...
  getReferences(): Observable<any> {
    ...
    return this.http
      .get<{
      datas: any;
    }>(`${environment.API_BASE_URL}/administration/references`, { headers })
      .pipe(map((response) => response.datas));
  }
  ...
  createReference(referenceName: string, typeName: string): Observable<void> {
    ...
    return this.http.put<void>(
      `${environment.API_BASE_URL}/administration/references`,
      body,
      { headers },
    );
  }
  ...
  getEquipments(): Observable<any> {
    ...
    return this.http
      .get<{
      datas: any;
    }>(`${environment.API_BASE_URL}/administration/equipments`, { headers })
      .pipe(map((response) => response.datas));
  }
  ...
  createEquipment(
    ...
    return this.http.put<void>(
      `${environment.API_BASE_URL}/administration/equipments`,
      body,
      { headers },
    );
  }
