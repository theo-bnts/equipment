...
export class AccountService {
  ...
  changePassword(email_address: string, old_password: string, new_password: string): Observable<void> {
    const body = { user: { email_address, old_password, password: new_password } };

    return this.http.post<void>(`${environment.API_BASE_URL}/account/password`, body);
  }
